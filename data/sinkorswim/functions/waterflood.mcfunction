...
execute unless entity @e[type=armor_stand,name="floodArmorStand"] run tellraw @a {"text": "A flash flood (water) is starting!"}
execute unless entity @e[type=armor_stand,name="floodArmorStand"] run scoreboard players set @e[type=armor_stand,name="waterFlood"] sinkOrSwimData 1